...
public class documentMatrix {
	...
	private String [] termColsArray;  //array of terms
	...
	documentMatrix(HashMap<String, Integer> globalWordMap, ArrayList<Preprocess> ppList, String[] directoryList) throws FileNotFoundException{
	...
	public void buildTFIDFMatrix() {
		...
		idf = new double [termColsArray.length];
	...
	public void generateTopics() throws FileNotFoundException {
		...
		try (PrintWriter out = new PrintWriter("src/test/java/com/knntextdata/knntextdata/topics.txt")) {
		    out.println(text);
		}
